            ...
            <div className="container shadow-sm mt-3 bg-white br-10">
                <div class="row p-2">
                    ...
                    <div className="col-sm-6 p-md-4">
                        <span class="vertical-align:middle;">Available</span> <span class="vertical-align:middle; display-6"> {loggedUser.country === 'India' ? '₹' : loggedUser.country === 'USA' ? '$' : loggedUser.country === 'Kuwait' ? 'د.ك' : loggedUser.country === 'Europe' ? '€' : 'Select'}{Number(loggedUser.savingAccount).toFixed(2)} </span> 
                    </div>
                </div>
            </div>
            <div className="container shadow-sm mt-3 bg-white br-10">
               <div class="row p-2">
                    ...
                    <div className="col-sm-6 p-md-4">
                        <span class="vertical-align:middle;">Available</span> <span class="vertical-align:middle; display-6"> {loggedUser.country === 'India' ? '₹' : loggedUser.country === 'USA' ? '$' : loggedUser.country === 'Kuwait' ? 'د.ك' : loggedUser.country === 'Europe' ? '€' : 'Select'}{Number(loggedUser.currentAccount).toFixed(2)} </span> 
                    </div>
                </div>
            </div>
        </div>
